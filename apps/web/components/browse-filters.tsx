      ...
      >
              ...
              .map((category) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'cursor-pointer rounded-md border px-2 py-1 text-xs transition-colors duration-200',
                      active
        ...
        <div>
          ...
          <select
            ...
            className="bg-surface hover:border-hover h-10 w-full cursor-pointer rounded-lg border px-3 text-sm transition-colors"
          >
